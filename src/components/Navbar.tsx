...
import { IoNotificationsOutline, IoLogoYoutube } from "react-icons/io5";

export default function Navbar() {
    return (
        <div className="bg-[#202020] px-[24px] flex items-center justify-between pt-[5px] pb-[10px] gap-[20px]">
            <div className="flex items-center gap-[20px]">
                <FiMenu className="text-[22px] text-white cursor-pointer" />
            ...
            <div className="flex items-center gap-[10px] flex-1 max-w-[600px]">
                <div className="flex items-center bg-[#121212] rounded-[25px] overflow-hidden w-full border border-[#2F2F2F]">
                    <input
                        type="text"
                        className="bg-transparent px-[20px] flex-1 text-white outline-none border-none text-[17px] hidden sm:block"
                        placeholder="Search"
                        spellCheck="false"
                    />
                    <div className="bg-[#313131] py-[10px] px-[20px] flex items-center justify-center h-full cursor-pointer w-full sm:w-auto">
                        <FiSearch className="text-white text-[21px]" />
                    </div>
                </div>
                <div className="bg-[#181818] p-[10px] rounded-[15px] cursor-pointer">
                    <FiMic className="text-[22px] text-white" />
                </div>
            </div>
            <div className="flex items-center gap-[25px]">
                <AiOutlineVideoCameraAdd className="text-white text-[23px] cursor-pointer hidden md:block" />
                <IoNotificationsOutline className="text-white text-[23px] cursor-pointer hidden md:block" />
                <div className="bg-[#313131] w-[40px] h-[40px] rounded-[100px] cursor-pointer"></div>
            </div>
        </div>
    );
}
